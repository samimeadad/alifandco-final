        ...
        <div className='w-100 overflow-hidden p-5' style={ { backgroundImage: `url(${ background })`, backgroundSize: "cover", overflow: 'hidden' } }>
            <Container className='my-5 fs-5 text-justify' style={ { textAlign: "justify" } }>
                ...
                <section className='my-5 text-justify'>
                    ...
                    <p className='text-justify my-4'>
                        At Alif & Co, we don’t just accept difference — we embrace it, we support it, and we thrive on it for the benefit of our employees, our services, and our communities. Alif & Co is committed to the principle of equal employment opportunity for all employees and to providing employees with a work environment free of discrimination and harassment. All employment decisions at Alif & Co are based on business needs, job requirements and individual qualifications, without regard to race, colour, religion or belief, family or parental status, or any other status protected by the laws or regulations in the United Kingdom. Alif & Co will not tolerate discrimination or harassment based on any of these characteristics above.
                    </p>
                    <p className='text-justify my-4'>
